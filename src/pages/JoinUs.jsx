...
const DEFAULT_JOIN_US_DATA = {
    hero_title: 'Ways to Give',
    hero_subtitle: 'Be part of a community that believes in the potential of every immigrant. Together, we can create lasting change and build a more inclusive Canada.',
    hero_button_text: 'Get Involved Today',
    hero_tagline: 'We are a non-profit ORG Empowering you to discover your inner eagle , Coaching you to soar, and Mentoring you to stay focused. Join us to empower others or be empowered!',
    ...
    give_description: 'Your generosity lifts newcomers and neighbours: helping more people learn, belong, and move forward. Think big. Belong fully. Give back.',

    onetime_title: 'One-Time Donation',
    onetime_description: 'Make a quick, secure gift online. Even a small donation makes a real difference—every dollar helps fuel workshops, coaching, mentorship, and community circles.',
    onetime_impact_heading: 'Examples of Impact:',
    onetime_impact_items: [
        { amount: '$25', text: 'Provides essential supplies for one youth workshop participant' },
        { amount: '$50', text: 'Covers transport and materials for a newcomer coaching session' },
        { amount: '$100', text: 'Sponsors a full cohort participant in community cooking or sewing' },
        { amount: '$250', text: 'Fuels a monthly community gathering circle & cultural exchange' }
    ],
    ...
    monthly_description: 'Monthly gifts give us reliable support and give you convenience and flexibility. Consider $10/$15/$20 per month to sustain program seats, coaching matches, and community sessions all year.',
    ...
    securities_btn_url: 'https://docs.google.com/forms/d/e/1FAIpQLSeCFnInCVyyaS5FA3-BYdb5nrjO45x3A1jVhYuQ76DpjGYcTA/viewform',
    ...
    corporate_btn_url: 'https://www.zeffy.com/embed/donation-form/corporate-partnerships-sponsor-a-program?modal=true',
...
const JoinUs = () => {
    const { data: rawData } = useJoinUsPageLive();
    const data = rawData || DEFAULT_JOIN_US_DATA;
    ...
    const communityImages = (rawCommunityImages || [])
        .filter((imgObj) => imgObj && typeof imgObj === 'object')
        .map((imgObj) => ({
            src: getMediaUrl(imgObj.image, imgObj.imageUrl || (typeof imgObj.image === 'string' ? imgObj.image : null)),
