...
const ProgramDetail = () => {
    ...
    // Delegate special layout programs to their components
    if (slug === "coaching") return <CoachingProgram />;
    if (slug === "mentorship") return <MentorshipProgram />;

    const { data, isLoading } = useProgramDetailLive(slug);
    ...
    const badge = data?.badge || "Culture & Community Program";
    const title = data?.title;
    const heroSubtitle = data?.hero_subtitle;

    const duration = data?.duration;
    const capacity = data?.capacity;
    const cost = data?.cost || "100% Free";
    ...
    const curriculumTitle = data?.curriculum_title || "Curriculum";
    const weeks = data?.weeks || [];
    const commitmentNote = data?.commitment_note;

    const ctaHeading = data?.cta_heading || `Ready to Start Your ${title} Journey?`;
    const ctaDescription = data?.cta_description || "Join our next cohort and build new skills in a supportive, judgment-free environment.";
    const registerButtonText = data?.register_button_text || "Register Now";
    const registerButtonUrl = data?.register_button_url || "https://docs.google.com/forms/d/e/1FAIpQLSfragX8BIMhxvgkFhyOc6nOJ7i8AJ9P8dl30OzlovYvCJ60zg/viewform";
                ...
                <section className="py-16">
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {leadInstructor && (
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-foreground">Lead Instructor / Support</p>
                            ...
                            {/* Week-by-Week Curriculum Section */}
