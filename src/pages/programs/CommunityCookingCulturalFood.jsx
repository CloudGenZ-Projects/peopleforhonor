...
import { Heart, Users, Calendar, DollarSign, Award, Clock, ArrowRight, CheckCircle2 } from "lucide-react";
...
const CommunityCookingCulturalFood = () => {
    const { data } = useProgramDetailLive('community-cooking-cultural-food');
